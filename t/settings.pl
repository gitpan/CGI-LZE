$VAR1 = {
        'admin'   => {'firstname' => 'Dirk', 'email' => 'lindnerei@o2online.de', 'street' => 'example 33', 'name' => 'Lindner', 'town' => 'Berlin'},
        'actions' => 'cgi-bin/config/actions.pl',
        'tree'          => {'navigation' => 'cgi-bin/config/tree.pl', 'links' => 'cgi-bin/config/links.pl'},
        'defaultAction' => 'news',
        'language'      => 'en',
        'version'       => '0.23',
        'cgi' => {'bin' => 'cgi-bin', 'style' => 'Crystal', 'serverName' => 'http://lindnerei.sourceforge.net/', 'cookiePath' => '/', 'title' => 'CGI::LZE', 'mod_rewrite' => 0, 'alias' => 'cgi-bin', 'DocumentRoot' => 'htdocs', 'expires' => '+1y'},
